...
namespace TKPhysics.AutomaticDynamicBone.Runtime.Editor
{
    ...
    public class ADBEditorColliderEditor : UnityEditor.Editor
    {
        [CustomEditor(typeof(ADBColliderReader))]
        public class ADBRuntimeEditor : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                Titlebar("ADBコライダータグ", Color.Lerp(Color.white, Color.blue, 0.5f));
