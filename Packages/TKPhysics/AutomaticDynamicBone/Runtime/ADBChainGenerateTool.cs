...
namespace TKPhysics.AutomaticDynamicBone.Runtime.Tool
{
    ...
    public class ADBChainGenerateTool :MonoBehaviour
    {
        ...
        public static void GenerateBoneChainImporter(Transform transform, List<string> generateKeyWordWhiteList, List<string> generateKeyWordBlackList, List<Transform> blackListOfGenerateTransform, ADBSettingLinker settings,ref List<ADBChainProcessor> chainProcessors)//OYM：一个巨丒嗦的方法
        {
            if (transform == null||
